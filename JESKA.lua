...
SUDO = SUDO
sudo_users = {SUDO,1540790740,1229026722}   
print([[
> CH › @Q7JJJ
> CH › @Jo7_7
~> DEVELOPER › @IIIYEIII
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/JESKA-DEV/Files_JESKA/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevJESKAW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevJESKAW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevJESKAW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevJESKAW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevJESKAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevJESKAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevJESKAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1540790740) then  
var = true  
elseif tonumber(user_id) == tonumber(1229026722) then
var = true  
...
local UserName = (data.username_ or "Q7JJJ")
...
local JESKA_Msg = ''  
if msgs < 100 then 
JESKA_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
JESKA_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
JESKA_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
JESKA_Msg = 'متفاعل' 
elseif msgs < 1200 then 
JESKA_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
JESKA_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
JESKA_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
JESKA_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
JESKA_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
JESKA_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
JESKA_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
JESKA_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
JESKA_Msg = 'رب التفاعل'  
end 
return JESKA_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@IIIYEIII")  
...
--------------------------------------------------------------------------------------------------------------
function SourceJESKA(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
Namot = (database:get(bot_id..'Name:Bot') or 'جيسكا')
SourceJESKAr = '*✫∫ اهلا عزيزي*\n*✫∫ انا بوت اسمي '..Namot..'*\n*✫∫ اختصاصي حمايه الكروبات*\n*✫∫ من تكرار والسبام والتوجيه والخ…*\n*✫∫ لتفعيلي اتبع الاخطوات…↓*\n*✫∫ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط*\n✫∫ [قناة سورس البوت](http://t.me/Q7JJJ)'
end
send(msg.chat_id_, msg.id_, SourceJESKAr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevJESKAW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevJESKAW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,JESKA_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ✫' and DevJESKAW(msg) then  
...
if text == 'تعطيل التواصل ✫' and DevJESKAW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✫' and DevJESKAW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✫' and DevJESKAW(msg) then  
...
if text == 'ضع كليشه ستارت ✫' and DevJESKAW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *✫∫ ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✫' and DevJESKAW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *✫∫ تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✫' and DevJESKAW(msg) then 
...
if text == 'تحديث السورس ✫' and DevJESKAW(msg) then 
os.execute('rm -rf JESKA.lua')
os.execute('wget https://raw.githubusercontent.com/JESKA-DEV/JESKA/main/JESKA.lua')
send(msg.chat_id_, msg.id_,' *✫∫ تم تحديث السورس* \n*✫∫ لديك اخر اصدار لسورس جيسكا*\n*✫∫ الاصدار » { 2.8v}*')
dofile('JESKA.lua')  
end
if text == 'الاصدار ✫' and DevJESKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *✫∫ اصدار سورس جيسكا* \n*✫∫ الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✫' and DevJESKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✫∫ [تحديثات البوت](t.me/Jo7_7) \n✫∫ [قناه السورس](t.me/Q7JJJ)')
end
if text == "ضع اسم للبوت ✫" and DevJESKAW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *✫∫ ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ✫' and DevJESKAW(msg) then 
...
if text == 'المشتركين ✫' and DevJESKAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✫∫ المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✫' and DevJESKAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✫∫ الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text=="اذاعه خاص ✫" and msg.reply_to_message_id_ == 0 and DevJESKAW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫∫ ارسل الان اذاعتك؟* \n*✫∫ للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✫" and msg.reply_to_message_id_ == 0 and DevJESKAW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫∫ ارسل الان اذاعتك؟* \n*✫∫ للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✫" and msg.reply_to_message_id_ == 0 and DevJESKAW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫∫ ارسل الان اذاعتك؟* \n*✫∫ للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✫" and msg.reply_to_message_id_ == 0  and DevJESKAW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫∫ ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✫" and msg.reply_to_message_id_ == 0  and DevJESKAW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✫∫ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✫' and DevJESKAW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✫" and DevJESKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ✫" and DevJESKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*✫∫ عدد الكروبات الان » { '..#group..' }'..JESKAk..''..JESKA..'*\n*✫∫ الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevJESKAW(msg) then
...
usertext = '*\n ✫∫ العضو »* ['..result.title_..'](t.me/'..(username or 'Q7JJJ')..')'
status  = '\n *✫∫ تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevJESKAW(msg) then
...
usertext = '\n *✫∫ العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Q7JJJ')..')'
status  = '\n*✫∫ تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevJESKAW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevJESKAW(msg) then
...
local JESKA1_Msg = database:get(bot_id.."JESKA1:Add:Filter:Rp2"..text..msg.chat_id_)   
if JESKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✫∫ العضو »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Q7JJJ')..') \n ✫∫ '..JESKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if JESKA_Msg and not Special(msg) then  
local JESKA_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if JESKA_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✫∫ العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✫∫ ["..JESKA_Msg.."] \n")
else
send(msg.chat_id_,0," *✫∫ العضو :* {["..data.first_name_.."](T.ME/Q7JJJ)}\n✫∫ ["..JESKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *✫∫ عذرا »* {["..data.first_name_.."](T.ME/Q7JJJ)}\n*✫∫ عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevJESKAW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevJESKAW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevJESKAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✫∫ حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevJESKAW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✫∫ حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✫" and DevJESKAW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *✫∫ تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✫$") and DevJESKAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✫∫ حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✫" and DevJESKAW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ✫" and DevJESKAW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *✫∫ تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✫" and DevJESKAW(msg) then  
...
database:sadd(bot_id.."JESKA:blocname"..msg.chat_id_, BlNe)
end
...
if t2.id_ then 
name_JESKA = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_JESKA then 
names_JESKA = database:smembers(bot_id.."JESKA:blocname"..msg.chat_id_) or ""
if names_JESKA and names_JESKA[1] then 
for i=1,#names_JESKA do 
if name_JESKA:match("(.*)("..names_JESKA[i]..")(.*)") then 
...
database:set(bot_id.."JESKA:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."JESKA:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."JESKA:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."JESKA:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."JESKA:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_JESKAa_new(JESKA1,JESKA2)
if JESKA2 and JESKA2.first_name_ then 
if JESKA2.first_name_:match("(.*)"..database:get(bot_id.."JESKA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."JESKA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local JESKA_nnn = database:get(bot_id.."JESKA:nump"..msg.chat_id_) or 5
local JESKA_nnn2 = database:get(bot_id.."JESKA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(JESKA_nnn2) == tonumber(JESKA_nnn) or tonumber(JESKA_nnn2) > tonumber(JESKA_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."JESKA:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✫∫ عزيزي >>["..JESKA2.username_.."](https://t.me/"..(JESKA2.username_ or "Q7JJJ")..")\n✫∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."JESKA:teh"..msg.chat_id_).."} بجانب اسمك\n✫∫ عدد المحاولات المتبقيه {"..(tonumber(JESKA_nnn) - tonumber(JESKA_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_JESKAa_new)
end
end
...
local JESKAChengName = database:get(bot_id.."JESKA:Cheng:Name"..data.id_)
if not data.first_name_ then 
if JESKAChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..JESKAChengName..']')
database:del(bot_id.."JESKA:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if JESKAChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."JESKA:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local JESKAChengUserName = database:get(bot_id.."JESKA:Cheng:UserName"..data.id_)
if not data.username_ then 
if JESKAChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..JESKAChengUserName..']')
database:del(bot_id.."JESKA:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if JESKAChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."JESKA:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local JESKAChengPhoto = database:get(bot_id.."JESKA:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if JESKAChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."JESKA:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if JESKAChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."JESKA:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ᴊᴇѕᴋᴀ\n\n[✫  ᴊᴇѕᴋᴀ ᴄʜᴀɴɴᴇʟ](http://t.me/Jo7_7)\n\n[✫  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/Q7JJJ)\n\n[✫  ᴊᴇѕᴋᴀ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/IIIYEIII)\n\n[✫  ʙᴏᴛ ᴊᴇѕᴋᴀ](http://t.me/HaMD_1bot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✫ sᴏᴜʀᴄʀ ᴊᴇѕᴋᴀ',url="t.me/Q7JJJ/10044"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Q7JJJ&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevJESKAW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *✫∫ بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Q7JJJ')..') \n*✫∫ تـم قفـل الدردشه* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✫∫ بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Q7JJJ')..') \n*✫∫ تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevJESKAW(msg) then
dofile('JESKA.lua')  
send(msg.chat_id_, msg.id_, ' *✫∫ تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevJESKAW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevJESKAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if JESKASudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevJESKAW(msg) then
...
if JESKASudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*✫∫ لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevJESKAW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevJESKAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevJESKAW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevJESKAW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevJESKAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevJESKAW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevJESKAW(msg) then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevJESKAW(msg) then
...
if DevJESKAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/JESKA-DEV/Files_JESKA/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevJESKAW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/JESKA-DEV/Files_JESKA/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('JESKA.lua')  
else
send(msg.chat_id_, msg.id_," *✫∫ عذرا الملف لايدعم سورس جيسكا* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevJESKAW(msg) then
...
if text == "مسح الملفات" and DevJESKAW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *✫∫ تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevJESKAW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevJESKAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "Q7JJJ")
...
function Function_JESKA(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_JESKA, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_JESKA, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✫∫ لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Q7JJJ')..')'
status  = '\n*✫∫ تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✫∫ العضو »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✫∫ العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Q7JJJ')..')'
...
database:set(bot_id.."JESKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end
if text then   
local tsssst = database:get(bot_id.."JESKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *✫∫ ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."JESKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."JESKA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."JESKA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."JESKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *✫∫ تم منع الكلمه مع التحذير*")  
database:del(bot_id.."JESKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."JESKA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."JESKA1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."JESKA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then
send(msg.chat_id_, msg.id_," *✫∫ ارسل الكلمه الان*")  
database:set(bot_id.."JESKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."JESKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."JESKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."JESKA1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."JESKA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
for k,v in pairs(list) do  
database:del(bot_id.."JESKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."JESKA1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."JESKA1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevJESKAW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *✫∫ تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevJESKAW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✫∫ العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'Q7JJJ')..')'..'\n*✫∫ تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevJESKAW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevJESKAW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'جيسكا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'جيسكا')
local JESKA_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..JESKA_Msg[math.random(#JESKA_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevJESKAW(msg) then 
...
if JESKASudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevJESKAW(msg) then 
...
if text == 'اضف رد للكل' and DevJESKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevJESKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'جيسكا').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevJESKAW(msg) then   
...
if text == 'تعطيل المغادره' and DevJESKAW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*✫∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'JESKA')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Q7JJJ')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
JESKAdx(msg.chat_id_, msg.id_, ' *✫∫ ايدي المجموعة » ( '..msg.chat_id_..' )*\n*✫∫ عدد الادمنيه » ( '..data.administrator_count_..' )*\n*✫∫ عدد المحظورين » ( '..data.kicked_count_..' )*\n*✫∫ عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevJESKAW(msg) then
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'جيسكا')
...
JESKA = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(JESKA)
...
--------------------------------------------------------------------------------------------------------------
SourceJESKA(data.message_,data)
...
------------------------------------------------------------------------
local JESKAAbot = database:get(bot_id.."JESKA1:Add:Filter:Rp2"..text..result.chat_id_)   
if JESKAAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✫∫ العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✫∫ ["..JESKAAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local JESKA1_Msg = database:get(bot_id.."JESKA1:Add:Filter:Rp2"..text..result.chat_id_)   
if JESKA1_Msg then
send(msg.chat_id_, msg.id_," ✫∫ "..JESKA1_Msg)
